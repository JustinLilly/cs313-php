<?php
	...
	<body>
        ...
        <div>
            <hr>
            <h2>Add User</h2>
            <?php include $_SERVER ['DOCUMENT_ROOT'] . '/cs313-php/web/projectOne/view/add-user.php'; ?>
        </div>
        <hr>
        <div>
            <?php include $_SERVER ['DOCUMENT_ROOT'] . '/cs313-php/web/projectOne/library/edit-event.php'; ?>
        </div>
